<?php
/**
 * mygroceries functions and definitions
 *
...
if ( ! function_exists( 'mygroceries_setup' ) ) :
	/**
	 ...
	 */
	function mygroceries_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on mygroceries, use a find and replace
		 * to change 'mygroceries' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'mygroceries', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'mygroceries' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'mygroceries_custom_background_args', array(
...
add_action( 'after_setup_theme', 'mygroceries_setup' );
 ...
 */
function mygroceries_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'mygroceries_content_width', 640 );
}
add_action( 'after_setup_theme', 'mygroceries_content_width', 0 );
 ...
 */
function mygroceries_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'mygroceries' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'mygroceries' ),
...
add_action( 'widgets_init', 'mygroceries_widgets_init' );
...
function mygroceries_scripts() {
	...
	wp_enqueue_script( 'mygroceries-popper', get_template_directory_uri() . '/js/popper.min.js', array(), '', true );
...
add_action( 'wp_enqueue_scripts', 'mygroceries_scripts' );
